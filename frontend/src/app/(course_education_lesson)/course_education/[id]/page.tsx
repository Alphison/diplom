            ...
            <div className="menu-content__course-education">
              {
                lessons_course?.map((item, i) => {
                  ...
                  return (
                    <motion.div variants={animStat2} animate="visible" initial="hidden" custom={i}  key={item.id} className="block-menu__course-education" onClick={() => router.push(`/lesson/${item.id}`)}>
                      <div className="img-block__sub-block">
